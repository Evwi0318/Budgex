...
namespace Budgex.Infrastructure.Migrations
{
    ...
    [Migration("20260825074745_SavingsPlan")]
    partial class SavingsPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.AllocationRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.EntryMonthState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EntryId", "Month")
                        .IsUnique();

                    b.ToTable("EntryMonthStates");
                });
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.SavingsMonthState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SavingsAccountId", "Month")
                        .IsUnique();

                    b.ToTable("SavingsMonthStates");
                });
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.AllocationRule", b =>
                {
                    b.HasOne("Budgex.Domain.Entities.SavingsAccount", null)
                        .WithMany("Rules")
            ...
            modelBuilder.Entity("Budgex.Domain.Entities.EntryMonthState", b =>
                {
                    b.HasOne("Budgex.Domain.Entities.Entry", null)
                        .WithMany()
